...
HD_PWD='D:/Downloads/CPU_design_v8.0/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_cpu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_cpu.tcl
